...
class _InvestigationsState extends State<Investigations> {
  ...
  //   setState(() {
  //     _file=File(file!.files.single.path.toString());
  //   });

  //   var newpath =_file.toString().split(' ');
  //    int end=newpath[1].toString().length-1;
  //   // print(newpath[1].toString().substring(1,end));//.toString().substring(2,end)
  //   uplodefile(newpath[1].toString().substring(1,end));
  // }
  // //uplod
  // void uplodefile(String filePathe)async{
  ...
  //   "phone":"075427642",
  //   "birthday":"2023-10-2",
  //   "file":await MultipartFile.fromFile(filePathe,filename:filename)
  //  });
  //  Response response = await Dio().get(Apiinsertpdf,data:formData);
  //  //Response response = await Dio().postUri(Uri.parse(Apiinsertpdf),data:formData,);
  //  print(response);
  //  try{
